/*
  ...
  - You are about to drop the column `awayTeam` on the `soccer_matches` table. All the data in the column will be lost.
  - You are about to drop the column `homeTeam` on the `soccer_matches` table. All the data in the column will be lost.
  - You are about to drop the column `winner` on the `soccer_matches` table. All the data in the column will be lost.
